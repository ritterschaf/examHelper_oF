    if('serviceWorker' in navigator){
        try {
            ...
            navigator.serviceWorker.ready.then(registration => registration.pushManager.subscribe({
                ...
                applicationServerKey: new Uint8Array([4, 191, 233, 62, 39, 98, 127, 174, 92, 188, 24,
                    206, 75, 102, 64, 151, 179, 246, 199, 199, 219, 147, 249, 90, 66, 204, 23, 151, 155, 154, 18, 134,
                    126, 21, 153, 253, 75, 104, 5, 95, 151, 16, 109, 15, 234, 218, 212, 117, 61, 187, 17, 226, 211, 17,
                    158, 185, 129, 165, 64, 74, 207, 85, 127, 255, 18])
            })).then(subscription => {
